...
namespace AspNetCoreSpa.Migrations
{
    ...
    [Migration("20170708060340_AddWorkingRecord")]
    partial class AddWorkingRecord
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("AspNetCoreSpa.Server.Entities.WorkingRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasIndex("UserId", "RecordeDate")
                        .IsUnique();

                    b.ToTable("WorkingRecords");
                });
